...
export default function Categories ({ active, budget, monthlyBudget, saveBudget, setBudget }) {
      ...
      <Accordion amount={incomeAmount} border title="Income">
        <div className="h-1 mt-1 border-t border-gray-300"></div>
          {monthlyBudget.categories.income.map((cat) =>
            <Category key={cat.id} active={active} budget={budget} category={cat} saveBudget={saveBudget} setBudget={setBudget} />
          )}
      </Accordion>
