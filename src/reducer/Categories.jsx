...
export default function Categories ({ active, budget, monthlyBudget, dispatch }) {
    ...
    <div className="">
      <Accordion amount={incomeAmount} border title="Income">
        <div className="h-1 mt-1 border-t border-gray-300"></div>
          ...
          <Category key={cat.id} active={active} budget={budget} category={cat} monthlyBudget={monthlyBudget} dispatch={dispatch} />
          )}
      </Accordion>
