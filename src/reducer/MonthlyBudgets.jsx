...
export default function MonthlyBudgets ({ active, budget, currentDate, dispatch }) {
  ...
  if (currentMonthlyBudget) {
    return <MonthlyBudget active={active} monthlyBudget={currentMonthlyBudget} budget={budget} dispatch={dispatch} />
  }
